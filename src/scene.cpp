...
Surface* json_parse_surface(const jsonvalue& json) {
    ...
    json_set_optvalue(json, surface->tform, "tform");
    json_set_optvalue(json, surface->rform, "rform");
    json_set_optvalue(json, surface->sform, "sform");
    json_set_optvalue(json, surface->isRoot, "isRoot");
    json_set_optvalue(json, surface->applyColor, "applyColor");
    json_set_optvalue(json, surface->hasChildren, "hasChildren");
    json_set_optvalue(json, surface->children, "children");
