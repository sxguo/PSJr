...
struct Surface {
    ...
    vec3f       tform;                      // translation for this node
    vec3f       rform;                      // rotation for this node
    vec3f       sform;                      // scale for this node

    bool          isRoot = false;
    bool          applyColor = false;       // color for this node
...
struct Scene {
    ...
    vector<mat4f>       xformlist;              // transformation "stack"
    vector<int>         rootlist;               // list of root shapes
